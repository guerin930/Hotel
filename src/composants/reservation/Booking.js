...
const Booking = () => {
    ...
    /*const tabRooms = [
        "Chambre reguliere simple",
        "Chambre reguliere basique",
        "Chambre reguliere standard",
        "Chambre reguliere deluxe",
        "Chambre familiale economique",
        "Chambre familiale basique",
        "Chambre familiale deluxe",
        "Suite junior economique",
        "Suite junior basique",
