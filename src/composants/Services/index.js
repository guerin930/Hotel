        ...
        <ServicesContainer id="services">
            ...
            <ServicesWrapper>
                ...
                <ServicesCard>
                    ...
                    <ServicesP>Parking gratuit et privé est disponible sur place., 
                        Parking accessible aux personnes à mobilité réduite, Parking intérieur, Places de stationnement sécurisé.</ServicesP>
                </ServicesCard>
                <ServicesCard>
                    <ServicesIcon src={icon2} />
                    <ServicesH2>Internet</ServicesH2>
                    <ServicesP>	Gratuit ! Une connexion Wi-Fi est disponible dans tout l'établissement gratuitement reservé aux clients.</ServicesP>
                </ServicesCard>
                <ServicesCard>
