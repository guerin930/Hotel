...
export default function RoomsFilter({rooms}) {
    ...
    return (
        <div className="container mt-5">
            <Title title="Catalogue des chambres" />
            <div className="row">
                <div className="col-md-6 col-12">
                    ...
                    <div className="form-group">
                        <label htmlFor="price">Prix de la chambre {price} FCFA</label>
                ...
                <div className="col-md-4 col-12 ml-auto">
                    <div className="custom-control custom-checkbox my-5">
                        ...
                        <label htmlFor="breakfast" className="custom-control-label">Petit Dejeuner</label>
                    </div>
                    <div className="custom-control custom-checkbox">
                        <input type="checkbox" className="custom-control-input" name="pets" id="pets" checked={pets} onChange={handleChange} />
                        <label htmlFor="pets" className="custom-control-label">Animal de compagnie</label>
                    </div>
                    <div className="input-group my-5">
                        <label htmlFor="size" className="mr-3">Dimensions </label>
