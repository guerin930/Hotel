    ...
    render() {
                    ...
                    <div className="row my-5">
                        <div className="col-md-6 col-12 mx-auto">
                            <div className="card shadow-lg border-0 p-4 error">
                                ...
                                <h3>Aucune chambre ne correspond...</h3>
        ...
        return (
            ...
            <Banner title={`${name} room`}>
                    <Link to="/rooms" className="btn btn-primary">Retour Aux chambres</Link>
            </Banner>
            </StyledHero>
            <section className="single-room container">
               ...
               <div className="single-room-info">
                   ...
                   <article className="infos">
                      <h3>Info</h3>
                      <h6>price : {price} FCFA</h6>
                      <h6>size  : {size} m²</h6>
                      <h6>
                          capacité max : {" "}
                              {capacity > 1 ? `${capacity} personnes`: `${capacity} personne`}
                      </h6>
                      <h6>{pets? 'animaux autorisé': "pas d'animaux autorisé"}</h6>
                      <h6>{breakfast && "petit dejeuner gratuit inclus"}</h6>
                   </article>
               </div>
            </section>
                ...
                <div className="p-4 clearfix">
                    <div className="row">
                       <div className="col-md-3 col-12 ml-auto">
                          <Link to={`/booknow/${this.state.slug}`} className="btn btn-outline-primary btn-block btn-lg float-right ">Reserver maintenant</Link>
                       </div>
                    </div>
                </div>
            </section>
